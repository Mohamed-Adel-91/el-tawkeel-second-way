    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="main-container">
                ...
                <form method="POST"
                    action="{{ isset($data) ? route('admin.shapes.update', $data->id) : route('admin.shapes.store') }}"
                        ...
                        <div class="col-12">
                            <div class="card h-100">
                                <div class="card-header">
                                    <div class="card-title">{{ isset($data) ? __('admin.forms.edit') : __('admin.forms.create') }} {{ __('admin.forms.shape_entity') }}
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="row gutters">
